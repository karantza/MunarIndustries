...
namespace Kasselblad {
  public class CameraFilterColorHiResTV : CameraFilter {
    private float brightness = .31f;

    private float vignetteAmount = 1f;
    ...
    public CameraFilterColorHiResTV() : base() { }
    ...
    public override void Load(string moduleName) {
      ...
      settings.SelectNode(moduleName + "ColorHiResTV");
